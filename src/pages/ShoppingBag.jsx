            ...
            {bagItems.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4 mt-4 w-full">
                ...
                <div className="flex justify-between w-full mt-8">
                  <Link
                    to="/"
                    className="flex flex-col items-center text-sm text-gray-700 hover:text-black focus:outline-none border border-black rounded-lg py-2 px-4"
                  >
                  ...
                  {bagItems.length > 0 && (
                    <button
                      ...
                      className="flex flex-col items-center text-sm text-gray-700 hover:text-black focus:outline-none border border-black rounded-lg py-2 px-4"
                    >
                      <FaCcPaypal className="w-5 h-5 mb-1" />
                      {`Checkout £${totalPrice}`}
                    </button>
                  )}
                </div>
